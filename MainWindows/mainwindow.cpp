...
//    ui->label_result->setText(QString::number(a));
    ...
    r.R(ui->lineEdit_r1->text().toDouble(), ui->lineEdit_r2->text().toDouble(), ui->lineEdit_r3->text().toDouble());
    r.set_r1(ui->lineEdit_r1->text().toDouble());
    r.set_r2(ui->lineEdit_r2->text().toDouble());
    r.set_r3(ui->lineEdit_r3->text().toDouble());
    ui->label_result->setText(QString::number(r.R(ui->lineEdit_r1->text().toDouble(), ui->lineEdit_r2->text().toDouble(), ui->lineEdit_r3->text().toDouble())));
    ...
    ui->plainTextEdit_allresult->appendPlainText("R = " + QString::number(r.R(ui->lineEdit_r1->text().toDouble(), ui->lineEdit_r2->text().toDouble(), ui->lineEdit_r3->text().toDouble())));
    ///
